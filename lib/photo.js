...
Photo.prototype.save = function(_callback) {
    ...
    _.each(photo.transformations, function(transformation, i) {
        actions.push(function(_callback) {
            return transform(photo, transformation, _callback)
        });
        // Carry original picture analysis
        // only once it has been transformed
        if (transformation.name === "original") {
            actions.push(function(_callback) {
                return analyze(photo, _callback);
            });
        }
    }, photo);
    ...
    _.each(photo.transformations, function(transformation, i) {
        actions.push(function(_callback) {
            return upload(photo, transformation, _callback)
        });
    }, photo);
